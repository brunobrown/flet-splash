    ...
    return [
        ft.Container(
            ...
            content=ft.Column(
                ...
                controls=[
                    ft.Icon(icon=ft.Icons.IMAGE, size=64, color=ft.Colors.TEAL),
                    ft.Text(value="Image Splash Example", size=24, weight=ft.FontWeight.BOLD),
                    ft.Text(
                        value="The app started with a custom image splash screen.",
                        size=14,
